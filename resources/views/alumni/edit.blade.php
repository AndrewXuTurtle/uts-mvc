                    ...
                    <form action="{{ route('alumni.update', $alumni->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                                               id="nama" name="nama" value="{{ old('nama', $alumni->nama) }}" required>
                                        @error('nama')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('program_studi') is-invalid @enderror" 
                                               id="program_studi" name="program_studi" value="{{ old('program_studi', $alumni->program_studi) }}" required>
                                        @error('program_studi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" class="form-control @error('ipk') is-invalid @enderror" 
                                               id="ipk" name="ipk" value="{{ old('ipk', $alumni->ipk) }}" 
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                               id="email" name="email" value="{{ old('email', $alumni->email) }}">
                                        @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('telepon') is-invalid @enderror" 
                                               id="telepon" name="telepon" value="{{ old('telepon', $alumni->telepon) }}">
                                        @error('telepon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="url" class="form-control @error('linkedin') is-invalid @enderror" 
                                               id="linkedin" name="linkedin" value="{{ old('linkedin', $alumni->linkedin) }}" 
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Format: JPG, PNG, GIF. Max: 2MB. Kosongkan jika tidak ingin mengubah foto</small>
                                    @error('foto')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('pekerjaan_sekarang') is-invalid @enderror" 
                                            ...
                                            <option value="Bekerja" {{ old('pekerjaan_sekarang', $alumni->pekerjaan_sekarang) == 'Bekerja' ? 'selected' : '' }}>Bekerja</option>
                                            <option value="Wirausaha" {{ old('pekerjaan_sekarang', $alumni->pekerjaan_sekarang) == 'Wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                                            <option value="Melanjutkan Studi" {{ old('pekerjaan_sekarang', $alumni->pekerjaan_sekarang) == 'Melanjutkan Studi' ? 'selected' : '' }}>Melanjutkan Studi</option>
                                            <option value="Belum Bekerja" {{ old('pekerjaan_sekarang', $alumni->pekerjaan_sekarang) == 'Belum Bekerja' ? 'selected' : '' }}>Belum Bekerja</option>
                                        </select>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('posisi') is-invalid @enderror" 
                                               id="posisi" name="posisi" value="{{ old('posisi', $alumni->posisi) }}">
                                        @error('posisi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_mulai_kerja') is-invalid @enderror" 
                                               id="tanggal_mulai_kerja" name="tanggal_mulai_kerja" value="{{ old('tanggal_mulai_kerja', $alumni->tanggal_mulai_kerja) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('alamat_perusahaan') is-invalid @enderror" 
                                              id="alamat_perusahaan" name="alamat_perusahaan" rows="2">{{ old('alamat_perusahaan', $alumni->alamat_perusahaan) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('gaji_range') is-invalid @enderror" 
                                           id="gaji_range" name="gaji_range" value="{{ old('gaji_range', $alumni->gaji_range) }}" 
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('testimoni') is-invalid @enderror" 
                                              ...
                                              placeholder="Ceritakan pengalaman Anda selama kuliah dan setelah lulus...">{{ old('testimoni', $alumni->testimoni) }}</textarea>
                                    @error('testimoni')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('pencapaian') is-invalid @enderror" 
                                              ...
                                              placeholder="Ceritakan pencapaian dan prestasi Anda setelah lulus...">{{ old('pencapaian', $alumni->pencapaian) }}</textarea>
                                    @error('pencapaian')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Update Data Alumni
                            </button>
                        </div>
                    </form>
                </div>
