                    ...
                    <form action="{{ route('matakuliah.store') }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control @error('sks') is-invalid @enderror"
                                   id="sks" name="sks" value="{{ old('sks') }}" required min="1" max="6">
                            @error('sks')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" class="form-control @error('kurikulum_tahun') is-invalid @enderror"
                                   id="kurikulum_tahun" name="kurikulum_tahun" value="{{ old('kurikulum_tahun', date('Y')) }}" required min="2000" max="{{ date('Y') + 1 }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select class="form-control @error('status_wajib') is-invalid @enderror"
                                ...
                                <option value="Wajib" {{ old('status_wajib', 'Wajib') == 'Wajib' ? 'selected' : '' }}>Wajib</option>
                                <option value="Pilihan" {{ old('status_wajib') == 'Pilihan' ? 'selected' : '' }}>Pilihan</option>
                            </select>
                            @error('status_wajib')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
