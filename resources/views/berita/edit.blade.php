                    ...
                    <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="is_prestasi" name="is_prestasi" value="1" {{ old('is_prestasi', $berita->is_prestasi) ? 'checked' : '' }} onchange="togglePrestasiFields()">
                        ...
                        <div id="prestasi-fields" style="display: {{ old('is_prestasi', $berita->is_prestasi) ? 'block' : 'none' }};">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nama_mahasiswa') is-invalid @enderror" 
                                                   id="nama_mahasiswa" name="nama_mahasiswa" value="{{ old('nama_mahasiswa', $berita->nama_mahasiswa) }}">
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nim') is-invalid @enderror" 
                                                   id="nim" name="nim" value="{{ old('nim', $berita->nim) }}">
                                            @error('nim')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('program_studi') is-invalid @enderror" 
                                               id="program_studi" name="program_studi" value="{{ old('program_studi', $berita->program_studi) }}">
                                        @error('program_studi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <select class="form-control @error('tingkat_prestasi') is-invalid @enderror" 
                                                ...
                                                <option value="Internasional" {{ old('tingkat_prestasi', $berita->tingkat_prestasi) == 'Internasional' ? 'selected' : '' }}>Internasional</option>
                                                <option value="Nasional" {{ old('tingkat_prestasi', $berita->tingkat_prestasi) == 'Nasional' ? 'selected' : '' }}>Nasional</option>
                                                <option value="Regional" {{ old('tingkat_prestasi', $berita->tingkat_prestasi) == 'Regional' ? 'selected' : '' }}>Regional</option>
                                                <option value="Lokal" {{ old('tingkat_prestasi', $berita->tingkat_prestasi) == 'Lokal' ? 'selected' : '' }}>Lokal</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('jenis_prestasi') is-invalid @enderror" 
                                                   id="jenis_prestasi" name="jenis_prestasi" value="{{ old('jenis_prestasi', $berita->jenis_prestasi) }}" 
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control @error('penyelenggara') is-invalid @enderror" 
                                                   id="penyelenggara" name="penyelenggara" value="{{ old('penyelenggara', $berita->penyelenggara) }}">
                                            @error('penyelenggara')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-md-6 mb-3">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_prestasi') is-invalid @enderror" 
                                                   id="tanggal_prestasi" name="tanggal_prestasi" value="{{ old('tanggal_prestasi', $berita->tanggal_prestasi ? $berita->tanggal_prestasi->format('Y-m-d') : '') }}">
