@if ($paginator->hasPages())
    <nav aria-label="Page navigation">
        <ul class="pagination pagination-sm justify-content-center">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->previousPageUrl() }}" rel="prev" style="padding: 0.25rem 0.5rem; font-size: 0.875rem;">
                        <i class="fas fa-chevron-left" style="font-size: 10px;"></i>
                        <span class="d-none d-sm-inline"> Previous</span>
                    </a>
                </li>
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next" style="padding: 0.25rem 0.5rem; font-size: 0.875rem;">
